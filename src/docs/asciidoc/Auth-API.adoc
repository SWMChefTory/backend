...
==== 요청
include::{snippets}/auth-controller-test/extract-user-id/token-reissue-scenario/valid-refresh-token/should-reissue-tokens/http-request.adoc[]

==== 요청 본문
include::{snippets}/auth-controller-test/extract-user-id/token-reissue-scenario/valid-refresh-token/should-reissue-tokens/request-body.adoc[]

==== 요청 필드
include::{snippets}/auth-controller-test/extract-user-id/token-reissue-scenario/valid-refresh-token/should-reissue-tokens/request-fields.adoc[]

==== 응답
include::{snippets}/auth-controller-test/extract-user-id/token-reissue-scenario/valid-refresh-token/should-reissue-tokens/http-response.adoc[]

==== 응답 본문
include::{snippets}/auth-controller-test/extract-user-id/token-reissue-scenario/valid-refresh-token/should-reissue-tokens/response-body.adoc[]

==== 응답 필드
include::{snippets}/auth-controller-test/extract-user-id/token-reissue-scenario/valid-refresh-token/should-reissue-tokens/response-fields.adoc[]