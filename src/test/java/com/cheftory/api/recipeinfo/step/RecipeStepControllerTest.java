    ...
    class GivenValidRecipeId {
      ...
      class WhenRequestingRecipeSteps {
        ...
        void setUp() {
          ...
          RecipeStep.Detail step1Detail1 = RecipeStep.Detail.builder()
              .text("김치 200g을 준비합니다")
              .start(0.0)
              .build();
          RecipeStep.Detail step1Detail2 = RecipeStep.Detail.builder()
              .text("돼지고기 150g을 준비합니다")
              .start(5.0)
              .build();
          ...
          RecipeStep.Detail step2Detail1 = RecipeStep.Detail.builder()
              .text("팬에 기름을 두르고 가열합니다")
              .start(30.0)
              .build();
          RecipeStep.Detail step2Detail2 = RecipeStep.Detail.builder()
              .text("김치와 돼지고기를 넣고 볶습니다")
              .start(45.0)
              .build();
        ...
        void thenShouldReturnRecipeSteps() {
          var response = given()
              ...
              .apply(document(
                  ...
                  responseFields(
                      ...
                      fieldWithPath("steps[].details[].start").description("단계 상세 설명 시작 시간(초)"),
          ...
          assertThat(responseBody.getString("steps[0].details[0].text")).isEqualTo("김치 200g을 준비합니다");
          assertThat(responseBody.getDouble("steps[0].details[0].start")).isEqualTo(0.0);
          assertThat(responseBody.getString("steps[0].details[1].text")).isEqualTo("돼지고기 150g을 준비합니다");
          ...
          assertThat(responseBody.getString("steps[1].details[0].text")).isEqualTo("팬에 기름을 두르고 가열합니다");
          assertThat(responseBody.getDouble("steps[1].details[0].start")).isEqualTo(30.0);
          assertThat(responseBody.getString("steps[1].details[1].text")).isEqualTo("김치와 돼지고기를 넣고 볶습니다");
    ...
    class GivenRecipeIdWithSingleStep {
      ...
      class WhenRequestingRecipeSteps {
        ...
        void setUp() {
          ...
          RecipeStep.Detail detail = RecipeStep.Detail.builder()
              .text("계란을 풀어서 프라이팬에 넣고 익혀주세요")
              .start(0.0)
              .build();
