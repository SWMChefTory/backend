...
class RecipeSearchHistoryServiceTest {

  @Mock private RecipeSearchHistoryRepository repository;
  @Mock private RecipeSearchHistoryKeyGenerator keyGenerator;
  @Mock private Clock clock;

  @InjectMocks private RecipeSearchHistoryService service;
