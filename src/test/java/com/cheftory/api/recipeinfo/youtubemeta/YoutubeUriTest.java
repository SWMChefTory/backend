...
class YoutubeUriTest {
  ...
  class GivenInvalidUrls {
    ...
    void invalidHost() {
      ...
      YoutubeMetaException ex =
          assertThrows(YoutubeMetaException.class, () -> YoutubeUri.from(invalidHost));
    ...
    void invalidPath() {
      ...
      YoutubeMetaException ex =
          assertThrows(YoutubeMetaException.class, () -> YoutubeUri.from(invalidPath));
    ...
    void nullQuery() {
      ...
      YoutubeMetaException ex =
          assertThrows(YoutubeMetaException.class, () -> YoutubeUri.from(nullQuery));
    ...
    void nullHost() {
      ...
      YoutubeMetaException ex =
          assertThrows(YoutubeMetaException.class, () -> YoutubeUri.from(nullHost));
    ...
    void nullPath() {
      ...
      YoutubeMetaException ex =
          assertThrows(YoutubeMetaException.class, () -> YoutubeUri.from(nullPath));
    ...
    void missingVParam() {
      ...
      YoutubeMetaException ex =
          assertThrows(YoutubeMetaException.class, () -> YoutubeUri.from(missingV));
    ...
    void emptyVParam() {
      ...
      YoutubeMetaException ex =
          assertThrows(YoutubeMetaException.class, () -> YoutubeUri.from(emptyV));
