...
public class RecipeInfoRecipeCategoryTest {
  ...
  class CreateRecipeInfoRecipeCategory {
    ...
    class GivenEmptyRecipeCategoryName {
    ...
    class GivenNullRecipeCategoryName {
    ...
    class GivenBlankRecipeCategoryName {
  ...
  class DeleteRecipeInfoRecipeCategory {
    ...
    class GivenActiveRecipeInfoRecipeCategory {
    ...
    class GivenAlreadyDeletedRecipeInfoRecipeCategory {
