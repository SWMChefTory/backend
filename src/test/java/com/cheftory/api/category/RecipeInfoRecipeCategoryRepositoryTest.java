  ...
  class FindRecipeInfoCategoriesByUser {
    ...
    class GivenOtherUsersCategories {
      ...
      void setUp() {
        ...
        RecipeCategory currentUserRecipeCategory =
            RecipeCategory.create(clock, "내카테고리", currentUserId);

        RecipeCategory otherUserRecipeCategory =
            RecipeCategory.create(clock, "남의카테고리", otherUserId);
