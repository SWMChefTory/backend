...
import com.cheftory.api.recipe.content.caption.entity.RecipeCaption.Segment;
...
public class RecipeCaptionRepositoryTest extends DbContextTest {
    ...
    class SaveRecipeCaption {
        ...
        class GivenValidParameters {
            ...
            void setUp() {
                ...
                segment = new Segment("Hello World", 0.0, 2.0);
            ...
            class WhenSaveRecipeCaption {
                ...
                void thenRecipeCaptionIsSaved() {
                    RecipeCaption savedRecipeCaption = recipeCaptionRepository
                            .findById(recipeCaption.getId())
                            .orElse(null);
    ...
    class FindRecipeCaptionById {
        ...
        class WhenFindRecipeCaptionById {
            ...
            @BeforeEach
            void setUp() {
                recipeCaption = RecipeCaption.from(
                        List.of(new Segment("Hello World", 0.0, 2.0)), LangCodeType.ko, recipeId, clock);
                recipeCaptionRepository.save(recipeCaption);
            ...
            void thenRecipeCaptionIsFound() {
                ...
                assertThat(foundRecipeCaption.getSegments().getFirst().getText())
                        .isEqualTo("Hello World");
                assertThat(foundRecipeCaption.getSegments().getFirst().getStart())
                        .isEqualTo(0.0);
        ...
        class WhenFindRecipeCaptionByRecipeId {
            ...
            void setUp() {
                ...
                foundRecipeCaption =
                        recipeCaptionRepository.findByRecipeId(recipeId).orElse(null);
            }
