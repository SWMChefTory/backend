...
import com.cheftory.api.recipe.content.youtubemeta.client.YoutubeVideoResponse;
...
class YoutubeVideoResponseTest {
  ...
  void getThumbnailUriReturnsMaxresUrl() {
    YoutubeVideoResponse.ThumbnailInfo maxres =
        new YoutubeVideoResponse.ThumbnailInfo(
            "https://i.ytimg.com/vi/test/maxresdefault.jpg", 1280, 720);
