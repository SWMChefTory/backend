        ...
        class GivenValidRecipeId {
            ...
            class WhenRequestingKoreanCaption {
                ...
                void thenShouldReturnKoreanCaption() {
                    ...
                    assertThat(responseBody.getString("captions[0].text")).isEqualTo("안녕하세요, 오늘은 김치찌개를 만들어보겠습니다");
            ...
            class WhenRequestingEnglishCaption {
                ...
                void setUp() {
                    ...
                    List<RecipeCaption.Segment> segments = List.of(
                            new RecipeCaption.Segment("Hello, today we're going to make kimchi stew", 0.0, 4.0),
                ...
                void thenShouldReturnEnglishCaption() {
                    ...
                    assertThat(responseBody.getString("captions[2].text")).isEqualTo("Also prepare 150 grams of pork");
                }
            }
            ...
            class WhenRequestingSingleSegmentCaption {
                ...
                void setUp() {
                    ...
                    List<RecipeCaption.Segment> segments = List.of(new RecipeCaption.Segment("간단한 요리 설명입니다", 0.0, 5.0));
