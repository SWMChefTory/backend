    ...
    class FetchRecipeSteps {
        ...
        class GivenValidCaption {
            ...
            """;
                ...
                // 첫 번째 단계 상세 검증
                ClientRecipeStepsResponse.Step firstStep =
                        actualResponse.steps().get(0);
                ...
                // 두 번째 단계 상세 검증
                ClientRecipeStepsResponse.Step secondStep =
                        actualResponse.steps().get(1);
                ...
                // 첫 번째 캡션 검증
                ClientRecipeStepsRequest.Caption firstCaption =
                        actualRequest.recipeCaptions().get(0);
                ...
                // 두 번째 캡션 검증
                ClientRecipeStepsRequest.Caption secondCaption =
                        actualRequest.recipeCaptions().get(1);
        ...
        class GivenDtoValidationEdgeCases {
            ...
            """;
                ...
                ClientRecipeStepsRequest.Caption caption =
                        actualRequest.recipeCaptions().get(0);
