    ...
    class FindAllByRecipeId {
        ...
        class GivenRecipeBriefingsExist {
            ...
            void setUp() {
                ...
                RecipeBriefing anotherRecipeBriefing = RecipeBriefing.create(anotherRecipeId, "다른 레시피의 브리핑", clock);
            ...
            class WhenFindAllByRecipeId {
                ...
                void shouldReturnOnlyTargetRecipeBriefings() {
                    ...
                    List<String> actualContents =
                            results.stream().map(RecipeBriefing::getContent).toList();
        ...
        class GivenNonExistentRecipeId {
            ...
            void setUp() {
                ...
                RecipeBriefing anotherBriefing = RecipeBriefing.create(anotherRecipeId, "다른 레시피의 브리핑", clock);
