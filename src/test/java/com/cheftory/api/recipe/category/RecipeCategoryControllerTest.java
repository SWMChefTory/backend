...
public class RecipeCategoryControllerTest extends RestDocsTest {
        ...
        class GivenValidParametersForCreate {
            ...
            class WhenCreatingRecipeCategory {
                ...
                void thenShouldCreateRecipeCategory() {
                    var response = given()
                        ...
                        .apply(
                            document(
                                ...
                                requestFields(
                                    fieldWithPath("name").description("레시피 카테고리 이름")
                                ),
                                responseFields(
                    ...
                    response.assertThat()
                        .body("recipe_category_id", equalTo(recipeCategoryId.toString()));
