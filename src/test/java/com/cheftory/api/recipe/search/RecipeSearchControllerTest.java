        ...
        class GivenValidSearchQuery {
            ...
            class WhenSearchingRecipes {
                ...
                void thenShouldReturnSearchResults() {
                    ...
                    assertThat(responseBody.getString("searched_recipes[0].tags[0].name"))
                            .isEqualTo("한식");
                    assertThat(responseBody.getString("searched_recipes[0].tags[1].name"))
                            .isEqualTo("찌개");
                    assertThat(responseBody.getString("searched_recipes[0].description"))
                            .isEqualTo("얼큰한 김치찌개 레시피");
                    assertThat(responseBody.getInt("searched_recipes[0].servings"))
                            .isEqualTo(2);
                    assertThat(responseBody.getInt("searched_recipes[0].cooking_time"))
                            .isEqualTo(30);
                    ...
                    assertThat(responseBody.getString("searched_recipes[0].video_type"))
                            .isEqualTo("NORMAL");
                    assertThat(responseBody.getString("searched_recipes[0].video_thumbnail_url"))
                            .isEqualTo("https://example.com/kimchi_thumbnail.jpg");
                    assertThat(responseBody.getInt("searched_recipes[0].video_seconds"))
                            .isEqualTo(300);
                    assertThat(responseBody.getBoolean("searched_recipes[0].is_viewed"))
                            .isEqualTo(true);
                    assertThat(responseBody.getLong("searched_recipes[0].credit_cost"))
                            .isEqualTo(7L);
        ...
        class GivenQueryWithMultipleResults {
            ...
            class WhenSearchingRecipes {
                ...
                void setUp() {
                    ...
                    doReturn(URI.create("https://example.com/kimchi.jpg"))
                            .when(meta1)
                            .getThumbnailUrl();
                ...
                void thenShouldReturnAllSearchResults() {
                    ...
                    assertThat(responseBody.getString("searched_recipes[0].recipe_title"))
                            .isEqualTo("김치찌개");
                    assertThat(responseBody.getString("searched_recipes[1].recipe_title"))
                            .isEqualTo("된장찌개");
        ...
        class GivenPaginatedSearchResults {
            ...
            class WhenSearchingSecondPage {
                ...
                void setUp() {
                    ...
                    doReturn(URI.create("https://example.com/pasta.jpg"))
                            .when(meta)
                            .getThumbnailUrl();
                    ...
                    searchResults =
                            new PageImpl<>(List.of(recipe), Pageable.ofSize(10).withPage(1), 11);
                    doReturn(searchResults)
                            .when(recipeSearchFacade)
                            .searchRecipes(any(Integer.class), any(String.class), any(UUID.class));
                }
