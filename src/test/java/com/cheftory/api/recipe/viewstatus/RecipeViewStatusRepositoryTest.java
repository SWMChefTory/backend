    ...
    class GivenValidRecipeIdAndUserId {
      ...
      class WhenCheckingExists {
        ...
        void thenShouldExist() {
          boolean exists = repository.existsByRecipeIdAndUserIdAndStatus(recipeId, userId,
    ...
    class GivenValidRecipeIdAndUserId {
      ...
      class WhenFindingByRecipeIdAndUserId {
        ...
        void thenShouldReturnRecipeViewStatus() {
          RecipeViewStatus foundStatus = repository.findByRecipeIdAndUserIdAndStatus(recipeId,
                  userId, RecipeViewState.ACTIVE)
              .orElseThrow();
    ...
    class GivenNonExistentRecipeIdAndUserId {
      ...
      class WhenFindingByRecipeIdAndUserId {
        ...
        void thenShouldReturnEmpty() {
          assertThat(repository.findByRecipeIdAndUserIdAndStatus(recipeId, userId,
              RecipeViewState.ACTIVE)).isEmpty();
        }
      }
    }
  }
    ...
    class GivenUncategorizedRecipeViewStatuses {
      ...
      class WhenFindingUncategorized {
        ...
        void thenShouldReturnUncategorizedRecipeViewStatuses() {
          ...
          var statuses = repository.findAllByUserIdAndRecipeCategoryIdAndStatus(userId, null,
              RecipeViewState.ACTIVE, pageable).getContent();
    ...
    class GivenCategorizedRecipeViewStatuses {
      ...
      class WhenFindingCategorized {
        ...
        void thenShouldReturnCategorizedRecipeViewStatuses() {
          ...
          Pageable pageable = PageRequest.of(page, 10);
          var statuses = repository.findAllByUserIdAndRecipeCategoryIdAndStatus(userId, categoryId,
              RecipeViewState.ACTIVE, pageable).getContent();
    ...
    class GivenValidUserId {
      ...
      class WhenFindingRecentRecipeViewStatusesByUserId {
        ...
        void thenShouldReturnRecentRecipeViewStatusesByUserId() {
          ...
          Page<RecipeViewStatus> page = repository.findByUserIdAndStatus(userId,
              RecipeViewState.ACTIVE, pageable);
      ...
      class WhenFindinTengRecentRecipeViewStatusesByUserId {
        ...
        void thenShouldReturnRecentRecipeViewStatusesByUserId() {
          ...
          // When
          Page<RecipeViewStatus> statusPage = repository.findByUserIdAndStatus(userId,
              RecipeViewState.ACTIVE, pageable);
        ...
        void thenShouldApplyPaginationCorrectly() {
          ...
          // When
          Page<RecipeViewStatus> firstPage = repository.findByUserIdAndStatus(userId,
              RecipeViewState.ACTIVE, firstPageable);
          ...
          assertThat(firstPageContent.get(9).getRecipeId()).isEqualTo(
              recipeIds.get(10)); // 10번째로 최근

          // Given - 두 번째 페이지
          Pageable secondPageable = PageRequest.of(1, 10, ViewStatusSort.VIEWED_AT_DESC);

          // When
          Page<RecipeViewStatus> secondPage = repository.findByUserIdAndStatus(userId,
              RecipeViewState.ACTIVE, secondPageable);
          ...
          assertThat(secondPageContent.get(0).getRecipeId()).isEqualTo(
              recipeIds.get(9)); // 11번째로 최근
          assertThat(secondPageContent.get(9).getRecipeId()).isEqualTo(
              recipeIds.get(0)); // 가장 오래된
        }
        ...
        void thenShouldReturnCorrectPageInfoForEmptyResult() {
          ...
          // When
          Page<RecipeViewStatus> emptyPage = repository.findByUserIdAndStatus(nonExistentUserId,
              RecipeViewState.ACTIVE, pageable);
    ...
    class CountRecipeViewStatusesByCategories {
      ...
      class GivenRecipeViewStatusesInMultipleCategories {
        ...
        class WhenCountingRecipeViewStatusesByCategories {
          ...
          void beforeEach() {
            IntStream.range(0, 3)
                .mapToObj(i -> {
                  RecipeViewStatus status = RecipeViewStatus.create(clock, userId,
                      UUID.randomUUID());
          ...
          void thenShouldReturnCorrectCountsForEachCategory() {
            List<RecipeViewStatusCountProjection> counts = repository.countByCategoryIdsAndStatus(
                categoryIds, RecipeViewState.ACTIVE);
      ...
      class GivenEmptyCategoryIds {
        ...
        class WhenCountingRecipeViewStatusesByEmptyCategories {
          ...
          void thenShouldReturnEmpty() {
            List<RecipeViewStatusCountProjection> counts = repository.countByCategoryIdsAndStatus(
                List.of(), RecipeViewState.ACTIVE);
            assertThat(counts.size()).isEqualTo(0);
          }
        }
      }
