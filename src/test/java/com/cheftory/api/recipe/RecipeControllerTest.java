        ...
        class GivenValidUserId {
            ...
            class WhenRequestingRecentRecipes {
                ...
                void setUp() {
                    ...
                    doReturn(LocalDateTime.of(2024, 1, 15, 10, 30, 0))
                            .when(recentRecipe)
                            .getViewedAt();
                    ...
                    doReturn(recentRecipes).when(recipeFacade).getRecents(any(UUID.class), any(Integer.class));
                }
                ...
                void thenShouldReturnRecentRecipes() {
                    var response = given().contentType(ContentType.JSON)
                            ...
                            .body(
                                    "recent_recipes",
                                    hasSize(recentRecipes.getContent().size()))
                            .apply(document(
                                    getNestedClassPath(this.getClass()) + "/{method-name}",
                                    requestPreprocessor(),
                                    responsePreprocessor(),
                                    ...
                                    responseFields(
                                            ...
                                            fieldWithPath("recent_recipes[].viewed_at")
                                                    .description("레시피 접근 시간"),
                                            fieldWithPath("recent_recipes[].last_play_seconds")
                                                    .description("레시피 마지막 재생 시간"),
                                            fieldWithPath("recent_recipes[].recipe_id")
                                                    .description("레시피 ID"),
                                            fieldWithPath("recent_recipes[].video_id")
                                            ...
                                            fieldWithPath("recent_recipes[].description")
                                                    .description("레시피 설명"),
                                            fieldWithPath("recent_recipes[].cook_time")
                                                    .description("조리 시간(분)"),
                                            fieldWithPath("recent_recipes[].servings")
                                                    .description("인분"),
                                            fieldWithPath("recent_recipes[].created_at")
                                                    .description("레시피 생성 일시"),
                                            fieldWithPath("recent_recipes[].tags")
                                                    .description("태그 목록"),
                                            fieldWithPath("recent_recipes[].tags[].name")
                                                    .description("태그 이름"),
        ...
        class GivenValidRecipeInfoIdAndUserId {
            ...
            class WhenRequestingRecipeInfoDetail {
                ...
                void thenShouldReturnRecipeDetail() {
                    var response = given().contentType(ContentType.JSON)
                            ...
                            .apply(document(
                                    ...
                                    responseFields(
                                            ...
                                            fieldWithPath("video_info.video_title")
                                                    .description("레시피 비디오 제목"),
                                            fieldWithPath("video_info.channel_title")
                                                    .description("레시피 채널명"),
                                            ...
                                            fieldWithPath("recipe_ingredient[].name")
                                                    .description("재료 이름"),
                                            fieldWithPath("recipe_ingredient[].amount")
                                                    .description("재료 양"),
                                            fieldWithPath("recipe_ingredient[].unit")
                                                    .description("재료 단위"),
                                            ...
                                            fieldWithPath("recipe_steps[].step_order")
                                                    .description("레시피 단계 순서"),
                                            fieldWithPath("recipe_steps[].subtitle")
                                                    .description("레시피 단계 제목"),
                                            fieldWithPath("recipe_steps[].details")
                                                    .description("레시피 단계 설명 목록"),
                                            ...
                                            fieldWithPath("view_status.viewed_at")
                                                    .description("레시피 마지막 시청 시간"),
                                            ...
                                            fieldWithPath("recipe_briefings[].content")
                                                    .description("브리핑 내용"),
                                            fieldWithPath("recipe_credit_cost").description("레시피 조회에 필요한 크레딧 비용"))));

                    verify(recipeFacade).viewFullRecipe(recipeId, userId);

                    var responseBody = response.extract().jsonPath();

                    assertThat(responseBody.getString("recipe_status")).isEqualTo(RecipeStatus.SUCCESS.name());
                    ...
                    assertThat(responseBody.getInt("view_status.last_play_seconds"))
                            .isEqualTo(60);
                    ...
                    assertThat(responseBody.getInt("recipe_steps[0].step_order"))
                            .isEqualTo(1);
                    assertThat(responseBody.getString("recipe_steps[0].subtitle"))
                            .isEqualTo("Step 1 Title");
                    assertThat(responseBody.getString("recipe_steps[0].details[0].text"))
                            .isEqualTo("Step 1 detail");
                    assertThat(responseBody.getDouble("recipe_steps[0].details[0].start"))
                            .isEqualTo(0.0);
                    assertThat(responseBody.getDouble("recipe_steps[0].start_time"))
                            .isEqualTo(0.0);

                    assertThat(responseBody.getString("recipe_ingredient[0].name"))
                            .isEqualTo("토마토");
                    assertThat(responseBody.getInt("recipe_ingredient[0].amount"))
                            .isEqualTo(2);
                    assertThat(responseBody.getString("recipe_ingredient[0].unit"))
                            .isEqualTo("개");

                    assertThat(responseBody.getString("recipe_detail_meta.description"))
                            .isEqualTo("맛있는 토마토 요리입니다");
                    assertThat(responseBody.getInt("recipe_detail_meta.servings"))
                            .isEqualTo(2);
                    assertThat(responseBody.getInt("recipe_detail_meta.cookingTime"))
                            .isEqualTo(30);
            ...
            class WhenRequestingRecipeInfoOverview {
                ...
                void setUp() {
                    ...
                    doReturn(URI.create("https://example.com/thumbnail.jpg"))
                            .when(recipeOverview)
                            .getThumbnailUrl();
                    doReturn(URI.create("https://example.com/video"))
                            .when(recipeOverview)
                            .getVideoUri();
                    ...
                    doReturn(recipeOverview).when(recipeFacade).getRecipeOverview(any(UUID.class), any(UUID.class));
                }
    ...
    class GetRecommendRecipes {
            ...
            class WhenRequestingRecommendRecipes {
                ...
                void thenShouldReturnRecommendRecipes() {
                            ...
                            .apply(document(
                                    ...
                                    responseFields(
                                            ...
                                            fieldWithPath("recommend_recipes[].channel_title")
                                                    .description("레시피 채널명"),
                                            fieldWithPath("recommend_recipes[].count")
                    ...
                    assertThat(responseBody.getString("recommend_recipes[0].recipe_title"))
                            .isEqualTo("Sample Recipe Title");
                    assertThat(responseBody.getList("recommend_recipes[0].tags"))
                            .hasSize(2);
                    assertThat(responseBody.getString("recommend_recipes[0].tags[0].name"))
                            .isEqualTo("한식");
                    assertThat(responseBody.getString("recommend_recipes[0].tags[1].name"))
                            .isEqualTo("간단요리");
                    assertThat(responseBody.getBoolean("recommend_recipes[0].is_viewed"))
                            .isEqualTo(true);
                    assertThat(responseBody.getString("recommend_recipes[0].description"))
                            .isEqualTo("맛있는 레시피입니다");
                    assertThat(responseBody.getInt("recommend_recipes[0].servings"))
                            .isEqualTo(2);
                    assertThat(responseBody.getInt("recommend_recipes[0].cooking_time"))
                            .isEqualTo(30);
                    ...
                    assertThat(responseBody.getString("recommend_recipes[0].channel_title"))
                            .isEqualTo("Sample Channel");
                    assertThat(responseBody.getInt("recommend_recipes[0].count"))
                            .isEqualTo(100);
                    assertThat(responseBody.getString("recommend_recipes[0].video_url"))
                            .isEqualTo("https://example.com/video");
                    assertThat(responseBody.getString("recommend_recipes[0].video_type"))
                            .isEqualTo("NORMAL");
                    assertThat(responseBody.getString("recommend_recipes[0].video_thumbnail_url"))
                            .isEqualTo("https://example.com/thumbnail.jpg");
                    assertThat(responseBody.getInt("recommend_recipes[0].video_seconds"))
                            .isEqualTo(180);
                    assertThat(responseBody.getLong("recommend_recipes[0].credit_cost"))
                            .isEqualTo(9L);
                    assertThat(responseBody.getString("current_page")).isEqualTo("0");
                    assertThat(responseBody.getString("total_pages")).isEqualTo("1");
                    assertThat(responseBody.getString("total_elements")).isEqualTo("1");
        ...
        class GivenQueryParameter {
            ...
            void callsServiceWithAllQuery() {
                ...
                verify(recipeFacade)
                        .getRecommendRecipes(RecipeInfoRecommendType.POPULAR, userId, page, RecipeInfoVideoQuery.ALL);
            }
        ...
        class GivenValidRecipeCategoryIdAndUserId {
            ...
            class WhenRequestingCategorizedRecipes {
                ...
                void setUp() {
                    ...
                    doReturn("Categorized Recipe Description")
                            .when(categorizedRecipe)
                            .getDescription();
                ...
                void thenShouldReturnCategorizedRecipes() {
                    var response = given().contentType(ContentType.JSON)
                            ...
                            .body(
                                    "categorized_recipes",
                                    hasSize(categorizedRecipes.getContent().size()))
                            .apply(document(
                                    getNestedClassPath(this.getClass()) + "/{method-name}",
                                    requestPreprocessor(),
                                    responsePreprocessor(),
                                    requestAccessTokenFields(),
                                    pathParameters(parameterWithName("recipe_category_id")
                                    ...
                                    responseFields(
                                            ...
                                            fieldWithPath("categorized_recipes[].tags")
                    ...
                    var responseBody = response.extract().jsonPath();
                    assertThat(responseBody.getUUID("categorized_recipes[0].recipe_id"))
                            .isEqualTo(recipeId);
                    ...
                    assertThat(responseBody.getInt("categorized_recipes[0].video_seconds"))
                            .isEqualTo(180);
                    assertThat(responseBody.getString("categorized_recipes[0].viewed_at"))
                            .isEqualTo("2024-01-20T14:30:00");
                    assertThat(responseBody.getInt("categorized_recipes[0].last_play_seconds"))
                            .isEqualTo(90);
                    ...
                    assertThat(responseBody.getInt("categorized_recipes[0].servings"))
                            .isEqualTo(2);
                    assertThat(responseBody.getInt("categorized_recipes[0].cook_time"))
                            .isEqualTo(30);
                    assertThat(responseBody.getString("categorized_recipes[0].created_at"))
                            .isEqualTo("2024-01-20T14:30:00");
                    assertThat(responseBody.getString("categorized_recipes[0].tags[0].name"))
                            .isEqualTo("한식");
                    assertThat(responseBody.getLong("categorized_recipes[0].credit_cost"))
                            .isEqualTo(6L);
                }
                ...
                void thenDetailMetaNullShouldReturnNullFields() {
                    ...
                    doReturn("Categorized Recipe Title")
                            .when(nullDetailMetaRecipe)
                            .getVideoTitle();
                    ...
                    var responseBody = response.extract().jsonPath();
                    assertThatObject(responseBody.get("categorized_recipes[0].description"))
                            .isNull();
                    assertThat(responseBody.getInt("categorized_recipes[0].servings"))
                            .isEqualTo(0);
                    assertThat(responseBody.getInt("categorized_recipes[0].cook_time"))
                            .isEqualTo(0);
                    assertThatObject(responseBody.get("categorized_recipes[0].created_at"))
                            .isNull();
                }
                ...
                void thenTagsNullShouldReturnNullFields() {
                    ...
                    var responseBody = response.extract().jsonPath();
                    assertThatObject(responseBody.get("categorized_recipes[0].tags"))
                            .isNull();
                }
            }
        }
        ...
        class GivenValidUserId {
            ...
            class WhenRequestingUnCategorizedRecipes {
                ...
                void setUp() {
                    ...
                    doReturn("Uncategorized Recipe Title")
                            .when(unCategorizedRecipe)
                            .getVideoTitle();
                    ...
                    doReturn("Uncategorized Recipe Description")
                            .when(unCategorizedRecipe)
                            .getDescription();
                ...
                void thenShouldReturnUnCategorizedRecipes() {
                    var response = given().contentType(ContentType.JSON)
                            ...
                            .body(
                                    ...
                                    hasSize(unCategorizedRecipes.getContent().size()))
                            .apply(document(
                                    getNestedClassPath(this.getClass()) + "/{method-name}",
                                    requestPreprocessor(),
                                    responsePreprocessor(),
                                    ...
                                    queryParameters(
                                            ...
                                            parameterWithName("cursor")
                                                    ...
                                                    .optional()),
                                    responseFields(
                                            fieldWithPath("unCategorized_recipes")
                                                    .description("미분류 레시피 목록"),
                    ...
                    assertThat(responseBody.getInt("unCategorized_recipes[0].video_seconds"))
                            .isEqualTo(240);
                    ...
                    assertThat(responseBody.getInt("unCategorized_recipes[0].servings"))
                            .isEqualTo(2);
                    assertThat(responseBody.getInt("unCategorized_recipes[0].cook_time"))
                            .isEqualTo(30);
                    ...
                    assertThat(responseBody.getString("unCategorized_recipes[0].tags[0].name"))
                            .isEqualTo("한식");
                    assertThat(responseBody.getLong("unCategorized_recipes[0].credit_cost"))
                            .isEqualTo(8L);
                }
                ...
                void thenDetailMetaNullShouldReturnNullFields() {
                    ...
                    doReturn(URI.create("https://example.com/uncategorized_thumbnail.jpg"))
                            .when(nullDetailMetaRecipe)
                            .getThumbnailUrl();
                    doReturn("uncategorized_video_id")
                            .when(nullDetailMetaRecipe)
                            .getVideoId();
                    ...
                    var responseBody = response.extract().jsonPath();
                    assertThatObject(responseBody.get("unCategorized_recipes[0].description"))
                            .isNull();
                    assertThat(responseBody.getInt("unCategorized_recipes[0].servings"))
                            .isEqualTo(0);
                    assertThat(responseBody.getInt("unCategorized_recipes[0].cook_time"))
                            .isEqualTo(0);
                    assertThatObject(responseBody.get("unCategorized_recipes[0].created_at"))
                            .isNull();
                }
                ...
                void thenTagsNullShouldReturnNullFields() {
                    ...
                    var responseBody = response.extract().jsonPath();
                    assertThatObject(responseBody.get("unCategorized_recipes[0].tags"))
                            .isNull();
                }
            }
        }
            ...
            class GivenValidUserId {
                ...
                class WhenRequestingRecipeInfoCategories {
                    ...
                    void thenShouldReturnRecipeCategoryCounts() {
                        var response = given().contentType(ContentType.JSON)
                                ...
                                .apply(document(
                                        ...
                                        responseFields(
                                                ...
                                                fieldWithPath("categories[].category_id")
                                                        .description("카테고리 ID"),
                                                fieldWithPath("categories[].count")
                                                        .description("해당 카테고리의 레시피 수"),
                                                fieldWithPath("categories[].name")
                                                        .description("카테고리 이름"),
                                                fieldWithPath("unCategorized_count")
                                                        .description("미분류 레시피 수"),
                        ...
                        assertThat(responseBody.getUUID("categories[0].category_id"))
                                .isEqualTo(categoryId);
                ...
                void thenShouldReturnRecipeProgress() {
                    var response = given().contentType(ContentType.JSON)
                            ...
                            .apply(document(
                                    ...
                                    responseFields(
                                            enumFields("recipe_status", "레시피의 현재 상태: ", RecipeStatus.class),
                                            fieldWithPath("recipe_progress_statuses")
                                                    .description("레시피 진행 상황 목록"),
                                            enumFields(
        ...
        class GivenRecipeInfoIdWithBriefing {
            ...
            class WhenRequestingRecipeInfoProgress {
                ...
                void thenShouldReturnProgressWithBriefing() {
                    ...
                    for (int i = 0; i < 4; i++) {
                        String step = responseBody.getString("recipe_progress_statuses[" + i + "].progress_step");
                        String detail = responseBody.getString("recipe_progress_statuses[" + i + "].progress_detail");
        ...
        class GivenComplexMultiStepProgressRecipeInfoId {
            ...
            class WhenRequestingRecipeInfoProgress {
                ...
                void setUp() {
                    ...
                    progresses = List.of(
                            progress1, progress2, progress3, progress4, progress5, progress6, progress7, progress8);
    ...
    class GetTrendingRecipes {
        ...
        class GivenValidUserId {
            ...
            void thenShouldGetTrendingRecipesSuccessfully() {
                ...
                doReturn(page)
                        .when(recipeFacade)
                        .getRecommendRecipes(RecipeInfoRecommendType.TRENDING, userId, 0, RecipeInfoVideoQuery.ALL);
                ...
                given().queryParam("page", 0)
                        ...
                        .body("recommend_recipes[0].video_thumbnail_url", equalTo("https://example.com/thumb1.jpg"))
                        ...
                        .body("recommend_recipes[1].video_thumbnail_url", equalTo("https://example.com/thumb2.jpg"))
            ...
            void thenShouldGetTrendingRecipesWithCursor() {
                ...
                given().queryParam("cursor", cursor)
                        .get("/api/v1/recipes/recommend/trending")
                        .then()
                        .status(HttpStatus.OK)
                        .body("recommend_recipes", hasSize(1))
        ...
        class GivenValidUserId {
            ...
            void thenShouldGetChefRecipesSuccessfully() {
                ...
                given().queryParam("page", 0)
                        ...
                        .body("recommend_recipes[0].video_thumbnail_url", equalTo("https://example.com/chef1.jpg"))
                        ...
                        .body("recommend_recipes[1].video_thumbnail_url", equalTo("https://example.com/chef2.jpg"))
            ...
            void thenShouldGetChefRecipesWithCursor() {
                ...
                doReturn(CursorPage.of(List.of(recipeOverview), nextCursor))
                        .when(recipeFacade)
                        .getRecommendRecipes(RecipeInfoRecommendType.CHEF, userId, cursor, RecipeInfoVideoQuery.ALL);
    ...
    class GetCuisineRecipes {
        ...
        class GivenValidCuisineType {
            ...
            void thenShouldGetCuisineRecipesSuccessfully() {
                ...
                var response = given().queryParam("page", 0)
                        .attribute("userId", userId.toString())
                        .header("Authorization", "Bearer accessToken")
                ...
                assertThat(responseBody.getString("cuisine_recipes[0].tags[0].name"))
                        .isEqualTo("한식");
                assertThat(responseBody.getBoolean("cuisine_recipes[0].is_viewed"))
                        .isEqualTo(false);
                ...
                assertThat(responseBody.getInt("cuisine_recipes[0].cooking_time"))
                        .isEqualTo(30);
                assertThat(responseBody.getString("cuisine_recipes[0].video_id"))
                        .isEqualTo("korean1");
                assertThat(responseBody.getString("cuisine_recipes[0].channel_title"))
                        .isEqualTo("한식 채널");
                ...
                assertThat(responseBody.getString("cuisine_recipes[0].video_type"))
                        .isEqualTo("NORMAL");
                assertThat(responseBody.getString("cuisine_recipes[0].video_thumbnail_url"))
                        .isEqualTo("https://example.com/korean1.jpg");
                assertThat(responseBody.getInt("cuisine_recipes[0].video_seconds"))
                        .isEqualTo(180);
                assertThat(responseBody.getLong("cuisine_recipes[0].credit_cost"))
                        .isEqualTo(11L);
            }
