...
class AffiliateCacheTest {
  ...
  @Autowired private AffiliateService service;

  @Autowired private RedisConnectionFactory connectionFactory;

  @MockitoBean private CoupangClient coupangClient;
  ...
  class CacheSaveAndRetrieveTest {
    ...
    void setUp() {
      ...
      doReturn("https://link.coupang.com/re/AFFSDP?...").when(coupangProduct).getProductUrl();
  ...
  class CacheTTLTest {
    ...
    void shouldExpireCacheAfterTTL() throws InterruptedException {
      ...
      CacheManager shortTTLCacheManager =
          RedisCacheManager.builder(connectionFactory).cacheDefaults(shortConfig).build();
