...
public class RestDocsUtils {
   ...
   */
  public static FieldDescriptor enumFields(
      String fieldName, String description, Class<? extends Enum<?>> enumClass) {
    String formattedEnumValues =
  ...
  public static String getNestedClassPath(Class<?> clazz) {
    ...
    while (clazz != null) {
      ...
      String className = clazz.getSimpleName().replaceAll("([a-z])([A-Z])", "$1-$2").toLowerCase();
