...
public class RestDocsUtils {
    ...
    public static OperationRequestPreprocessor requestPreprocessor() {
        return Preprocessors.preprocessRequest(
                Preprocessors.modifyUris().scheme("http").host("test.host").removePort(), Preprocessors.prettyPrint());
    }
     ...
     */
    public static FieldDescriptor enumFields(String fieldName, String description, Class<? extends Enum<?>> enumClass) {
    ...
    public static String getNestedClassPath(Class<?> clazz) {
        ...
        while (clazz != null) {
            ...
            String className =
                    clazz.getSimpleName().replaceAll("([a-z])([A-Z])", "$1-$2").toLowerCase();
