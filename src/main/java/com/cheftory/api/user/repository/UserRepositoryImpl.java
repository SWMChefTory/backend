...
public class UserRepositoryImpl implements UserRepository {
	...
	public User find(UUID userId) throws UserException {
		return userJpaRepository.findByIdAndUserStatus(userId, UserStatus.ACTIVE)
	...
	public boolean exist(Provider provider, String providerSub) {
		return
				userJpaRepository.existsByProviderAndProviderSubAndUserStatus(provider, providerSub, UserStatus.ACTIVE);
	}
	...
	@Override
	public User update(UUID id, String nickname, Gender gender, LocalDate dateOfBirth, Clock clock) throws UserException {
