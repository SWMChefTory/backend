package com.cheftory.api.recipe.content.caption.client;

import com.cheftory.api.recipe.content.caption.client.dto.ClientCaptionErrorResponse;
import com.cheftory.api.recipe.content.caption.client.dto.ClientCaptionRequest;
...
public class CaptionClient {
        ...
        try {
            return webClient
                    ...
                    .onStatus(status -> !status.is2xxSuccessful(), response -> response.bodyToMono(
                                    ClientCaptionErrorResponse.class)
                            .map(this::mapToException)
                            .onErrorReturn(new CaptionClientException(CaptionClientErrorCode.SERVER_ERROR)))
    ...
    private CaptionClientException mapToException(ClientCaptionErrorResponse errorResponse) {
        ...
        return switch (errorResponse.getErrorCode()) {
            case "CAPTION_001", "CAPTION_004" -> new CaptionClientException(CaptionClientErrorCode.NOT_COOK_VIDEO);
