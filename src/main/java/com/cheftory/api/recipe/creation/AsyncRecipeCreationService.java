...
public class AsyncRecipeCreationService {
    ...
    public void create(UUID recipeId, long creditCost, String videoId, URI videoUrl) {
        ...
        try {
            ...
            CompletableFuture<Void> detailFuture =
                    CompletableFuture.runAsync(() -> progressDetail(recipeId, videoId, caption), recipeCreateExecutor);
            ...
            CompletableFuture<Void> briefingFuture =
                    CompletableFuture.runAsync(() -> progressBriefing(recipeId, videoId), recipeCreateExecutor);
    ...
    private void progressDetail(UUID recipeId, String videoId, RecipeCaption caption) {
        ...
        recipeProgressService.create(recipeId, RecipeProgressStep.DETAIL, RecipeProgressDetail.INGREDIENT);
        ...
        recipeDetailMetaService.create(recipeId, detail.cookTime(), detail.servings(), detail.description());
        recipeProgressService.create(recipeId, RecipeProgressStep.DETAIL, RecipeProgressDetail.DETAIL_META);
    }
    ...
    private RecipeCaption progressCaption(UUID recipeId, String videoId) {
        ...
        recipeProgressService.create(recipeId, RecipeProgressStep.CAPTION, RecipeProgressDetail.CAPTION);
    ...
    private void progressBriefing(UUID recipeId, String videoId) {
        ...
        recipeProgressService.create(recipeId, RecipeProgressStep.BRIEFING, RecipeProgressDetail.BRIEFING);
    }

    private void finalizeRecipe(UUID recipeId) {
        recipeInfoService.success(recipeId);
        recipeProgressService.create(recipeId, RecipeProgressStep.FINISHED, RecipeProgressDetail.FINISHED);
    }
